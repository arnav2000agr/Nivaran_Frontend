 ...
 */
declare const findAxisByName: (chartComponent: Charts, name: string) => ChartAxisType | undefined;
/**
 ...
 */
declare const findPaneByIndex: (chartComponent: Charts, index: number) => ChartPaneType | undefined;
/**
 ...
 */
declare const findPaneByName: (chartComponent: Charts, name: string) => ChartPaneType | undefined;
/**
 ...
 */
declare const exportVisual: (chartComponent: Charts, options?: any) => Group | undefined;
