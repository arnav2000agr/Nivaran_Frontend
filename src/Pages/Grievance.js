  ...
  return (
    <div className='flex flex-col'>
        ...
        <div className='flex w-screen justify-center items-center content-center self-center p-10'>
            ...
            <p className='text-black text-lg p-2'> Microphone : {listening ? <ToggleOnIcon style={{color: 'red', fontSize:'2.5em'}}/> : <ToggleOffIcon style={{color: 'black',fontSize:'2.5em'}}/>  }</p>
        </div>


        <div className='flex w-screen justify-center items-center content-center self-center'>
            <p onClick={() => setText(transcript)} className='p-5 h-auto w-1/2 m-0 mb-10 mt-10 text-black text-md border border-double rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-500 dark:focus:border-blue-500'>
            {transcript} 
        </p>
        </div>
        ...
        <div className='flex flex-col md:flex-row w-screen justify-center items-center content-center self-center p-10'>
            ...
            <button
            className='text-black bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br  shadow-cyan-500/50 dark:shadow-lg dark:shadow-cyan-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2'
            >
            <ContentCopyIcon/>
